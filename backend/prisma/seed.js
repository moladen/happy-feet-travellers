...
const tours = [
  ...
  },
  {
    ...
    relatedBlogSlugs: ['packing-smart-for-the-indian-mountains'],
...
const blogs = [
  ...
  },
  {
    ...
    relatedTourSlugs: ['spiti-valley-group-expedition-jun-2026'],
...
async function main() {
  ...
  const { page: rannPage, created: rannCreated } = await ensureRannLandingPage(prisma);
  console.log(
    rannCreated
      ? `  ✓ Rann landing page seeded (${rannPage.slug})`
      : `  ✓ Rann landing page already present (${rannPage.slug})`
  );
